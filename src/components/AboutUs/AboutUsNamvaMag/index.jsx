...
export default function AboutUsNamavaMag(){
    return(
        <div className="container-md container">
            <div className="d-flex flex-md-row flex-column justify-center align-stretch gap-3">
                <div className="col-sm-4 col-12 aboutUsMagCard d-flex flex-column justify-evenly align-center gap-4 border-radius-12 ">
                ...
                <div className="col-sm-4 col-12 aboutUsMagCard d-flex flex-column justify-btw align-center gap-4 border-radius-12  position-relative">
