...
export default function Footer(){
        ...
        useEffect(() => {
            ...
            setDropdownItems(remainingItems > 0 ? items.slice(-remainingItems) : []);
            };
    ...
    return(
        <Fragment>
            <div class="footer d-flex flex-column gap-3 justify-evenly ">
      {/* Responsive Section */}
            {isSmallScreen ? (
                <select>
            ...
            <div class="footerLinksContainer">
                <div class="container">
                <ul class="footerLinks d-flex justify-evenly align-center">
                    {/* Your existing footer links code */}
                </ul>
                </div>
            </div>
        ...
        <div class="footerInfo">
            <div class="container-small">
                <div class="d-flex flex-column gap-3">
                    <div class="footerDownload d-flex flex-row flex-xs-column justify-btw align-center border-radius-5 gap-1 gap-xs-2">
                        <div class="footerLogo d-flex justify-start gap-2 align-center col-xl-7 col-lg-9 col-12">
                            <div class="blueLogo border-radius-8 text-center">
                                <img src="./assets/images/footerBlueLogo.svg" class="d-inline-block"/>
                            </div>
                            <p>دانلود اپلیکیشن</p>
                        </div>
                        <div class="footerDownloadLinks d-flex flex-row  justify-evenly gap-xl-2 gap-1 align-center col-xl-5 col-lg-3 col-12">
                            <div class="footerDownloadLink col-xl-4 col-sm-3 col-2 border-radius-6 d-flex justify-evenly gap-1 align-center">
                                <img src="./assets/images/bazaar.svg" />
                                <div class="footerDownloadLinkText d-xl-flex flex-column gap-1 d-none">
                                    <span class="font-8">دریافت از</span>
                                    <p class="font-12">بازار</p>
                                </div>
                            </div>
                            <div class="footerDownloadLink col-xl-4 col-sm-3 col-2 border-radius-6 d-flex justify-evenly gap-1 align-center">
                            ...
                            <div class="footerDownloadLink col-xl-4 col-sm-3 col-2 border-radius-6 d-flex justify-evenly gap-1 align-center">
                                ...
                                <div class="footerDownloadLinkText d-xl-flex flex-column gap-1 d-none">
                                    <span class="font-8">دریافت از</span>
                                    <p class="font-12">گوگل پلی</p>
                                </div>
                            </div>
                            <a class="footerMoreLink col-xl-3 col-3 active font-14 text-center">بیشتر</a>
                        </div>
                    </div>
                    <div class="footerContent d-flex flex-row flex-xs-column  justify-btw align-center gap-xs-2">
                        <div class="footerContentText col-12 col-xl-8 col-lg-9 col-md-10 d-flex flex-column gap-1">
                            <p class="font-12">درباره نماوا</p>
                            <p class="font-12">سرزمین شاتل در سایت نماوا امکان پخش آنلاین فیلم‌ها و سریال‌های محبوبتان را در اختیار شما کاربران گرامی قرار می‌دهد. مشاهده پیش‌نمایش فیلم و سریال‌ها، جستجوی سریع مجموعه انتخابی، دانلود درون‌برنامه‌ای، حساب چند کاربره، تنظیمات کودک، پخش زنده رویدادهای ورزشی و فرهنگی و آرشیوی کامل از پرطرفدارترین فیلم‌ها و سریال‌ها از جمله قابلیت‌های نماوا، به‌روزترین سایت تماشای فیلم و سریال است. نماوا این امکان را برای کاربران خود فراهم کرده است تا در سریع‌ترین زمان ممکن و تنها با چند کلیک، سریال‌ها و فیلم‌های مورد علاقه خود را به صورت آنلاین و آفلاین مشاهده کنند.</p>
                        </div>
                        <div class="footerContentNamads d-flex flex-lg-row-reverse flex-sm-column  flex-xs-row-reverse justify-xs-start align-lg-center align-end col-12 col-xl-3 col-lg-3 col-md-2 gap-2">
                            <a href="#" class="d-inline-block border-radius-5 text-center">
                                <img class="w-100 h-auto" src="https://www.namava.ir/images/enamad.png" />
                            </a>
                            <a href="#" class="d-inline-block border-radius-5 text-center">
                                <img class="w-100 h-auto"  src="https://www.namava.ir/images/enamad.png" />
                            </a>
