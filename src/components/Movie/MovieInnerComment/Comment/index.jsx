        ...
        <div className="d-flex flex-column gap-7">
            <div className="d-flex align-start justify-center gap-2">
                ...
                <div className="col-12 d-flex flex-column align-start gap-4" style={{borderBottom: 'solid 1px #37383e'}}>
                    <p className="font-md-12 font-weight-normal light-white-font author-and-created_at">{author} - {created_at}</p>
                    <p className="font-md-12 white-color font-weight-normal content">{content}</p>
