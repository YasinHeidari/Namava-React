        ...
        <div className="container">
          <div className="d-flex flex-column justify-center align-start gap-2">
            ...
            >
              {/* First Slide */}
              <SwiperSlide
                className={`movieSlider col-4 d-flex flex-column align-center ${selectedMovie === 1 ? "selected" : ""}`}
                ...
                <div className="position-relative">
                  ...
                  />
                    ...
                    <div className="darkMovieCover position-absolute top-0 left-0 w-100 h-100 d-flex flex-column justify-end align-start gap-1 border-radius-5">
                      ...
                      <div className="d-flex justify-center align-center">
                        <p className="white-color font-12">فیلم - ۱۴۰۰</p>
                      </div>
                    </div>
              ...
              {/* Second Slide */}
              <SwiperSlide
                className={`movieSlider col-4 d-flex flex-column align-center ${selectedMovie === 2 ? "selected" : ""}`}
                ...
                <div className="position-relative">
                  ...
                  />
                    ...
                    <div className="darkMovieCover position-absolute top-0 left-0 w-100 h-100 d-flex flex-column justify-end align-start gap-1 border-radius-5">
                      ...
                      <div className="d-flex justify-center align-center">
                        <p className="white-color font-12">فیلم - ۱۳۹۴</p>
                      </div>
                    </div>
                </div>
