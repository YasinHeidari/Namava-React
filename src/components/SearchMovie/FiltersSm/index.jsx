...
export default function FiltersSm({ isMenuVisible, toggleMenuVisibility }) {
    ...
    return (
        <div
            className={`searchFiltersContainerSm d-lg-none d-flex flex-column gap-2 position-fixed z-3 top-0 col-12 h-100 ${
        ...
        >
                ...
                <div className="d-flex justify-start align-center gap-1">
                    <button className="reverse" onClick={toggleMenuVisibility}>
                        ...
                        >
                            ...
                            >
                                <path d="M14.77 18.793c0-.493.196-.967.545-1.315l6.2-6.2a1.86 1.86 0 0 1 2.626 2.633l-4.88 4.882 4.88 4.88a1.86 1.86 0 0 1-2.63 2.63l-6.2-6.2c-.347-.348-.54-.82-.54-1.31z"></path>
                            </g>
                        </svg>
                    </button>
                    <p className="white-color font-16 font-weight-normal">
                        فیلترها
                    </p>
                </div>
                <button
                    className="active font-14 line-height-28 reset-btn"
                    onClick={handleReset}
                >
                    حذف همه
                </button>
            ...
            <div className="d-flex justify-start align-center gap-2 searchFilterBorder">
                <div className="d-flex gap-1">
                    ...
                    />
                    <label
                        className="white-color font-weight-normal font-14"
                        htmlFor="فیلم"
                    >
                        فیلم
                    </label>
            ...
            />
            <CountryFilter
                checkboxes={selectedCountries}
                setCheckboxes={setSelectedCountries}
