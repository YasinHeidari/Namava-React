              ...
              <div className='d-flex flex-column gap-2  align-start'>
                ...
                {searchResults.persons[0].profile_path && (
                  <div key={searchResults.persons[0].id} className="col-12 d-lg-flex d-none align-start  gap-2 border-radius-12 personContainer">
                    <div>
                      <img className='personImgContainer border-radius-50 object-cover' src={`https://image.tmdb.org/t/p/w200${searchResults?.persons[0]?.profile_path}`} alt={searchResults.persons[0].name} />
                    </div>
                  ...
                  >
                    <div className='position-relative w-100 '>
                      ...
                      <div className='darkShowCover position-absolute z-1 top-0 right-0 w-100  d-flex flex-column justify-end align-start gap-1 border-radius-5'>
                        <div className="d-flex justify-center align-center"><div><img src={IMDB} alt="IMDB" /></div><p className="white-color font-14">{ratingDecimal(item.vote_average)}</p></div>
                        <div className="d-flex justify-center align-center"><div><img src={SubScript} alt="SubScript" /></div><p className="white-color font-12"> زیرنویس </p></div>{/**yh*/}
