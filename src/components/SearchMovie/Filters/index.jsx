...
export default function Filters({ onGenresChange, onCountriesChange }) {
  ...
  const handleGenreChange = (updatedGenres) => {
    ...
    onGenresChange(updatedGenres); // Notify parent component
  };

  const handleCountryChange = (updatedCountries) => {
    setSelectedCountries(updatedCountries);
    onCountriesChange(updatedCountries); // Notify parent component
  };
  ...
  return (
    <div className="searchFiltersContainer border-radius-12 d-lg-flex d-none flex-column gap-2 position-fixed right-0 z-0" style={{ top: '21%' }}>
