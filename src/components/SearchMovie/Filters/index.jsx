...
const filteredMovies = searchResults.movies.filter(movie =>
    Array.isArray(movie.genre_ids) && movie.genre_ids.some(genre_id => selectedGenres[genre_id]) &&
    Array.isArray(movie.production_countries) && movie.production_countries.some(country => selectedCountries[country.iso_3166_1])
);
    ...
    return(
        <div className="searchFiltersContainer border-radius-12 d-flex flex-column gap-2 position-fixed right-0 z-0" style={{ top: '21%' }}>
          ...
          <GenreFilter
            ...
            />
          <CountryFilter checkboxes={checkboxes} setCheckboxes={setCheckboxes} handleCountryChange={handleCountryChange} />
