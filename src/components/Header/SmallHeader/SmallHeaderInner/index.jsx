      ...
      <div className="d-lg-none d-block">
        <div
          className={classNames(
            "header col-12 z-3 top-0 right-0",
            { sticky: isHeaderVisible },
          ...
          <div className="container">
            <div className="d-flex justify-btw align-center">
              ...
              <div className="d-flex justify-center align-center gap-2 gap-xs-1">
                <Link
                  className="d-inline-block menuSubscription font-12 font-weight-normal"
                  to="/"
                >
                  خرید اشتراک
                </Link>
                <Link className="signInImg" to="/">
                  <img
                    className="w-100"
                    src={
                      require("../../../../images/sign-in-mobile.svg").default
                    }
                    alt=""
                  />
                </Link>
                <Link
                  className="d-md-inline-block d-xs-none signIn border-radius-5 font-md-12 font-weight-normal"
                  to="/"
                >
                  ورود/ثبت نام
                </Link>
