...
export default function Episodelg({ seriesId, showName , numberOfSeasons , popularity }) {
        ...
        <div className="d-lg-flex d-none flex-column align-start gap-3">
            ...
            <div className='d-flex flex-wrap col-12 ' >
                {episodes.map((episode) => {
                    ...
                    return (
                        <Link to="/" key={episode.id} className='d-flex flex-column gap-1 col-sm-12 col-xs-12 col-md-3 col-lg-4 col-xxl-3 ' style={{ marginBottom: '1rem',  padding:'0 .5rem'}}>
